        ...
        <main className="grid h-full grid-cols-1 sm:grid-cols-2">
            <div className="relative p-8">
                ...
                <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
                    <Form<CreateFirstUserParams> form={form} className="flex w-64 flex-col gap-4" onFinish={mutateAsync}>
                        <FormItem<CreateFirstUserParams> name="username" noStyle>
                            <Input placeholder="用户名" autoComplete="off" />
                        </FormItem>
                        <FormItem<CreateFirstUserParams> name="phone" noStyle>
